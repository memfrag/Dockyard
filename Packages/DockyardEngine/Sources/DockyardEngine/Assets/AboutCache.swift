...
public struct AboutCache: Sendable {

    public let directory: URL
    private let urlSession: URLSession

    public init(directory: URL = AboutCache.defaultDirectory, urlSession: URLSession = .shared) {
    ...
    public static var defaultDirectory: URL {
        ...
        return caches.appending(path: "Dockyard/About")
    }
    ...
    /// Evicts cached about pages for URLs outside `liveURLs` — superseded revisions
    ...
    func cacheFile(for remoteURL: URL) -> URL {
        ...
        let ext = remoteURL.pathExtension.isEmpty ? "md" : remoteURL.pathExtension
    ...
    private func download(_ url: URL, to destination: URL) async throws {
        ...
        do {
            ...
            if let http = response as? HTTPURLResponse, !(200..<300).contains(http.statusCode) {
                ...
                throw EngineError.downloadFailed(underlying: "About HTTP \(http.statusCode)")
            }
